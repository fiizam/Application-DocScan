...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        // Menghilangkan warna solid dan membuat AppBar transparan
        backgroundColor: Colors.transparent,
        elevation: 0,
        // Menggunakan flexibleSpace untuk menampilkan gradien yang sama dengan body
